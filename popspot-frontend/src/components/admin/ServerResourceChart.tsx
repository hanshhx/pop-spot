    ...
    <div className="w-full bg-[#111] border border-gray-800 rounded-2xl p-6 shadow-2xl">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-lime-300/20 rounded-lg">
            <Activity className="w-6 h-6 text-lime-300" />
          </div>
          <div>
        ...
        <div className="flex gap-4">
          <div className="text-right">
            ...
            <p className="text-lime-300 font-mono font-bold">{data[data.length - 1]?.cpu || 0}%</p>
          </div>
          <div className="text-right border-l border-gray-800 pl-4">
            ...
            <p className="text-emerald-400 font-mono font-bold">
              {data[data.length - 1]?.memory || 0} MB
            </p>
          </div>
        </div>
      </div>
