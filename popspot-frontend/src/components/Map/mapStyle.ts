...
const SHOP_KINDS = [
  "restaurant", "cafe", "convenience", "bar", "bakery",
  "beauty", "pub", "fast_food", "clothes", "bank",
];
...
export function buildBaseStyle(mode: MapMode, tileUrl: string, showShops = false): any {
  ...
  return {
    ...
    layers: [
      ...
      { id: "earth", type: "fill", source: SRC, "source-layer": "earth", paint: { "fill-color": t.earth } },
      {
        id: "landuse-green", type: "fill", source: SRC, "source-layer": "landuse",
        filter: ["match", ["get", "kind"],
          ["park", "forest", "wood", "grass", "recreation_ground", "golf_course", "cemetery", "zoo", "farmland", "scrub", "grassland", "garden"], true, false],
        paint: { "fill-color": t.park },
      },
      { id: "water", type: "fill", source: SRC, "source-layer": "water", paint: { "fill-color": t.water } },
      {
        id: "buildings", type: "fill", source: SRC, "source-layer": "buildings", minzoom: 13,
        paint: { "fill-color": t.building, "fill-opacity": ["interpolate", ["linear"], ["zoom"], 13, 0, 14.5, 1] },
      },
      {
        id: "roads-minor", type: "line", source: SRC, "source-layer": "roads",
        filter: ["match", ["get", "kind"], ["minor_road", "path", "other"], true, false], minzoom: 12,
        paint: { "line-color": t.roadMinor, "line-width": ["interpolate", ["exponential", 1.6], ["zoom"], 12, 0.4, 15, 2, 18, 8] },
      },
      {
        id: "roads-medium", type: "line", source: SRC, "source-layer": "roads",
        filter: ["==", ["get", "kind"], "medium_road"],
        paint: { "line-color": t.roadMedium, "line-width": ["interpolate", ["exponential", 1.6], ["zoom"], 10, 0.6, 15, 4, 18, 14] },
      },
      {
        id: "roads-major", type: "line", source: SRC, "source-layer": "roads",
        filter: ["==", ["get", "kind"], "major_road"],
        paint: { "line-color": t.roadMajor, "line-width": ["interpolate", ["exponential", 1.6], ["zoom"], 8, 0.7, 15, 5, 18, 18] },
      },
      {
        id: "roads-highway", type: "line", source: SRC, "source-layer": "roads",
        filter: ["==", ["get", "kind"], "highway"],
        paint: { "line-color": t.roadHighway, "line-width": ["interpolate", ["exponential", 1.6], ["zoom"], 6, 0.8, 15, 6, 18, 22] },
      },
      {
        id: "rail", type: "line", source: SRC, "source-layer": "roads",
        filter: ["==", ["get", "kind"], "rail"], minzoom: 11,
        paint: { "line-color": t.rail, "line-width": ["interpolate", ["linear"], ["zoom"], 11, 0.8, 16, 3], "line-dasharray": [3, 1.5] },
      },
      {
      ...
      {
        id: "place-neighbourhood", type: "symbol", source: SRC, "source-layer": "places",
        filter: ["match", ["get", "kind"], ["neighbourhood", "macrohood"], true, false], minzoom: 12,
        layout: { "text-field": NAME_KO, "text-font": ["Noto Sans Regular"], "text-size": 11, "text-max-width": 8 },
        paint: { "text-color": t.labelSmall, "text-halo-color": t.labelHalo, "text-halo-width": 1.2 },
      },
      {
        id: "place-locality", type: "symbol", source: SRC, "source-layer": "places",
        filter: ["match", ["get", "kind"], ["locality", "region", "country"], true, false],
        layout: {
          "text-field": NAME_KO, "text-font": ["Noto Sans Regular"],
          "text-size": ["interpolate", ["linear"], ["zoom"], 8, 12, 14, 16], "text-max-width": 8,
        },
        paint: { "text-color": t.label, "text-halo-color": t.labelHalo, "text-halo-width": 1.6 },
      },
      {
        id: "shops", type: "symbol", source: SRC, "source-layer": "pois", minzoom: 16,
        filter: ["match", ["get", "kind"], SHOP_KINDS, true, false],
        layout: {
          visibility: showShops ? "visible" : "none",
          "text-field": NAME_KO, "text-font": ["Noto Sans Regular"], "text-size": 10, "text-max-width": 7, "text-optional": true,
        },
        paint: { "text-color": t.labelSmall, "text-halo-color": t.labelHalo, "text-halo-width": 1.2 },
      },
      {
        id: "subway-dot", type: "circle", source: SRC, "source-layer": "pois",
        filter: ["==", ["get", "kind"], "station"], minzoom: 12,
        paint: {
          "circle-color": t.subway, "circle-radius": ["interpolate", ["linear"], ["zoom"], 12, 3, 16, 5.5],
          "circle-stroke-width": 1.5, "circle-stroke-color": t.labelHalo,
        },
      },
      {
        id: "subway-label", type: "symbol", source: SRC, "source-layer": "pois",
        filter: ["==", ["get", "kind"], "station"], minzoom: 13,
        layout: {
          "text-field": STATION_LABEL, "text-font": ["Noto Sans Regular"], "text-size": 11,
