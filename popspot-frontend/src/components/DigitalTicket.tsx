...
import { Sparkles, MapPin, Calendar, User, Eye, X } from 'lucide-react';
  ...
  return (
    <>
      <div className="w-full h-full flex items-center justify-center relative p-2 md:p-4">
        ...
        <div className="absolute top-[-10%] left-[10%] md:left-[20%] w-[50%] md:w-[30%] h-[50%] bg-lime-300/40 rounded-full blur-[80px] md:blur-[120px] animate-pulse pointer-events-none" />
        <div className="absolute bottom-[-10%] right-[10%] md:right-[20%] w-[50%] md:w-[30%] h-[50%] bg-lime-300/40 rounded-full blur-[80px] md:blur-[120px] animate-pulse delay-1000 pointer-events-none" />
        ...
        >
          ...
          <div className="flex-1 p-5 md:p-8 lg:p-12 flex flex-col justify-between relative z-10 border-b md:border-b-0 md:border-r border-dashed border-white/20">
            ...
            <div className="flex justify-between items-center mb-6 md:mb-10">
              <div className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1 md:py-1.5 rounded-full border border-white/10 bg-white/5">
                <Sparkles className="w-3 h-3 md:w-3.5 md:h-3.5 text-lime-300" />
                <span className="text-[9px] md:text-[11px] font-black tracking-[0.1em] md:tracking-[0.2em] text-cream-200 uppercase leading-none">
                  {category || 'POP-UP'}
                </span>
              </div>
              <div className="flex items-center gap-1.5 md:gap-2 bg-green-500/10 px-2.5 md:px-3 py-1 md:py-1.5 rounded-full border border-green-500/20">
                ...
                <span className="text-[9px] md:text-[11px] font-bold text-green-400 tracking-tighter leading-none">
                  {status || 'OPEN'}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2 md:space-y-4 text-left">
              ...
              <div className="flex items-start gap-1.5 md:gap-2 text-white/60">
                <MapPin className="w-4 h-4 md:w-4.5 md:h-4.5 text-lime-300 mt-0.5 md:mt-1 shrink-0" />
                <span className="text-xs sm:text-sm md:text-base lg:text-lg font-medium leading-snug">
                  {address}
                </span>
              </div>
            </div>
            ...
            <div className="mt-8 md:mt-12 flex flex-wrap gap-6 md:gap-10">
              <div className="space-y-1 md:space-y-1.5">
                <p className="text-[8px] md:text-[10px] text-white/30 uppercase tracking-widest font-bold leading-none">
                  Valid Until
                </p>
                <div className="flex items-center gap-1.5 md:gap-2 text-white font-bold text-sm md:text-lg leading-none">
                  <Calendar className="w-3.5 h-3.5 md:w-4 md:h-4 text-lime-300" /> {date}
                </div>
              </div>
              <div className="space-y-1 md:space-y-1.5">
                <p className="text-[8px] md:text-[10px] text-white/30 uppercase tracking-widest font-bold leading-none">
                ...
                <div className="flex items-center gap-1.5 md:gap-2 text-white font-bold text-sm md:text-lg leading-none">
                  <User className="w-3.5 h-3.5 md:w-4 md:h-4 text-hot-400" />{' '}
                  {userName || 'VIP GUEST'}
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-64 lg:w-80 bg-black/40 p-6 md:p-8 flex flex-col items-center justify-center relative z-10 py-8 md:py-0">
            ...
            >
              ...
              <span className="text-[9px] md:text-[10px] lg:text-[11px] font-black text-white/80 group-hover:text-black tracking-widest uppercase leading-none">
                로드뷰 확인
              </span>
              ...
              <div className="fixed inset-0 z-[999999] flex items-center justify-center p-2 sm:p-6 md:p-12">
                ...
                >
                  ...
                  <div className="absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 px-4 md:px-6 py-2 md:py-3 bg-black/60 backdrop-blur-md border border-white/10 rounded-full z-[1000001] flex items-center gap-2 md:gap-3 shadow-lg whitespace-nowrap max-w-[90%] overflow-hidden">
                    ...
                    <span className="text-white text-xs md:text-sm font-bold tracking-tight truncate">
                      {name} 목적지 뷰
                    </span>
                  </div>
                </motion.div>
