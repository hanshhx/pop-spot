        ...
        <div className="p-4 md:p-6 pb-2 flex flex-col gap-3 md:gap-4 bg-white dark:bg-ink-700 sticky top-0 z-10">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-500 dark:text-cream-200/60 mt-0.5">실시간 유동인구 및 혼잡도 분석</p>
                </div>
                <button onClick={onClose} className="p-1.5 md:p-2 bg-gray-100 dark:bg-white/10 rounded-full hover:rotate-90 transition-transform" aria-label="닫기">
            ...
            <>
                ...
                <div className={`p-4 md:p-6 rounded-2xl border-2 transition-colors ${
                    ...
                    <div className="flex items-end justify-between">
                        <div>
                            <p className="text-xs md:text-sm text-gray-500 dark:text-cream-200/60 mb-0.5 md:mb-1">현재 혼잡도</p>
