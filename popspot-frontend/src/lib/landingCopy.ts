...
const ko: LandingCopy = {
  ...
  mapShownOf: (s, t) => `${t}곳 중 ${s}곳 표시 — 나머지는 지도에 찍을 좌표가 아직 없습니다`,
...
const en: LandingCopy = {
  ...
  mapShownOf: (s, t) => `${s} of ${t} shown — the rest have no map coordinates yet`,
...
const ja: LandingCopy = {
  ...
  mapShownOf: (s, t) => `${t}件中${s}件を表示 — 残りは地図に表示する座標がまだありません`,
