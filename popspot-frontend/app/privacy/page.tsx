        ...
        <article className="prose prose-sm dark:prose-invert max-w-none space-y-10 leading-relaxed">
          ...
          <Section title="제2조 (개인정보의 이용 목적)">
            ...
            <Note>
              ...
              방문자 ID · 페이지 경로 · 봇 식별용 브라우저 정보(User-Agent)를 기록하며, IP와 회원
          ...
          <Section title="제3조 (개인정보의 보유 및 이용 기간)">
            <Ul
              items={[
                ...
                '익명 방문 로그(방문자 ID·경로·User-Agent) — 3개월간 보관 후 자동 파기',
          ...
          <Section title="제10조 (쿠키 및 분석 도구)">
            <p>
              로그인 유지를 위한 필수 쿠키와 서비스 품질 개선용 분석 도구 (Sentry, Vercel Analytics)
              를 사용합니다. 광고용 추적 쿠키는 사용하지 않습니다. 분석 도구는 개인을 식별할 수 없는
              형태의 통계 정보만 수집합니다.
            </p>
          </Section>
