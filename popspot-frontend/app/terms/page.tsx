    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-12 lg:py-16">
        <header className="mb-10">
          ...
          <p className="text-sm text-muted-foreground mt-2">최종 개정일: 2026-07-22</p>
        </header>
        ...
        <article className="prose prose-sm dark:prose-invert max-w-none space-y-10 leading-relaxed">
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-foreground/90">
              ...
              <li>
                자동수집 정보에는 항상 원본 출처 링크가 함께 표시되며, 회사는 본문을 임의로 대량
                복제·재배포하지 않습니다.
              </li>
              <li>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-foreground/90">
              ...
              <li>
                본 조에 따른 자동수집 결과의 저작권은 원 콘텐츠 게시자에게 있으며, 회사는 출처
                표시와 변형 가공을 통해 <strong>「공정 이용 (fair use) · 인용」</strong> 의 범위
                안에서 팝업스토어 정보 안내 목적으로만 활용합니다.
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <p className="text-foreground/90 mb-4">
              회사는 개인정보보호법 제15조 및 정보통신망법 제22조에 따라 다음과 같이 회원의
              개인정보를 수집·이용합니다. 회원가입 시 본 조항에 동의함으로써 효력이 발생합니다.
            </p>
                ...
                <tbody className="divide-y divide-[var(--color-border)]">
                  <tr>
                    ...
                    <td className="px-3 py-2 text-foreground/80">
                      이메일(아이디), 비밀번호(암호화 저장), 이름(닉네임), 생년월일, 성별,
                      휴대전화번호
                      <br />
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-foreground/90">
              ...
              <li>
                사이트맵에 포함되는 페이지는 운영자가 직접 작성한 정적 안내 페이지로 한정합니다.
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1 text-foreground/80">
              ...
              <li>
                <strong>자동수집된 팝업스토어 상세 페이지</strong>는 제10조의2 의 &ldquo;검색 결과
                자체를 본 서비스에서 재현하지 않는다&rdquo; 정책과 일관성을 유지하기 위해 사이트맵에
                포함하지 않습니다. 페이지 자체는 클라이언트 측에서 렌더링되어 검색 크롤러가 본문을
                수집하지 못합니다.
              </li>
              <li>
                회원이 작성한 동행 모집글 · 의견 · 채팅 등의 게시물은 클라이언트 측 렌더링으로
                제공되어 현재 검색엔진에 노출되지 않습니다. 향후 서버 사이드 렌더링으로 전환되어
                검색에 노출될 가능성이 생기는 경우, 회사는 사전에 공지하고 약관 개정을 통해 회원의
                재동의를 받습니다.
              </li>
              <li>
