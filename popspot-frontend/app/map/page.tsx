...
const DESCRIPTION =
  '서울 팝업스토어 위치를 지도 한 화면에서. 오늘 · 이번 주 팝업 일정과 성수 · 홍대 · 강남 등 지역별 위치, 마감일을 로그인 없이 무료로 확인.';
...
const MAP_COPY = {
  ko: {
    ...
    placeUnit: '곳',
    description:
      '서울에서 진행 중인 팝업스토어 위치와 오늘 · 이번 주 일정을 지도 한 화면에서 봅니다. 지도를 움직이면 그 지역의 팝업이 표시되고, 핀을 누르면 영업 기간과 마감일을 확인할 수 있습니다. 로그인 없이 무료입니다.',
