      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm text-ink-700/80 dark:text-cream-100/80 sm:text-base">
            서비스 출시 전 백엔드에 실제 적용한 보안·정책 안전장치입니다.
            사용자의 정보와 권리를 보호하기 위해 모든 항목을 운영 환경에 반영했습니다.
          </p>
        </motion.div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {SECURITY_CARDS.map((card, i) => (
            ...
            >
              ...
              <div className={`inline-flex h-11 w-11 items-center justify-center rounded-xl ${ACCENT_BG[card.accent]}`}>
        ...
        >
          ...
          <p className="mt-3 max-w-xl text-sm text-ink-700/80 dark:text-cream-100/80 sm:text-base">
            이용약관과 개인정보 처리방침에 모든 항목이 명시되어 있습니다.
            저작권 / 정보 오류 신고는 각 팝업 상세 페이지의 신고 버튼이나
            아래 이메일로 연락 주시면 24시간 안에 응답드립니다.
          </p>
