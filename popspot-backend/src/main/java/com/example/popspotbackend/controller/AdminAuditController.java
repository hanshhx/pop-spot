...
public class AdminAuditController {
     ...
     *
     * <p>목록(아래 {@code list})은 <b>이미 무엇을 찾을지 아는</b> 사람이 쓰는 화면이다. 이건 그 반대로, 무엇을 찾아야 할지 모를 때 <b>이상한 것이
     * 눈에 띄게</b> 하는 자리다 — 실패가 늘었나, 낯선 곳에서 접속했나, 되돌릴 수 없는 일이 있었나, 개인정보를 꺼냈나.
     *
     * <p>응답의 IP 는 가려서 나간다. 온전한 주소는 감사 로그 원본에 있고, 요약 화면까지 평문으로 복제하면 같은 개인정보를 보관하는 자리만 하나 더 늘어난다.
     *
