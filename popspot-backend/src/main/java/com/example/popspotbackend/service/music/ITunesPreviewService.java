 ...
 *
 * <p>배경: Spotify 가 2024-11 부터 신규 앱의 {@code preview_url} 을 null 로 반환. Free / 미연결 사용자가
 * 깨끗한 미리듣기를 못 듣고 YouTube 로 폴백되던 문제 해결. Apple iTunes 는 아직 preview_url (90초 m4a)
 * 을 무료 / 키 불필요로 제공한다.
 *
 * <p>흐름: Spotify 메타 (artist + track) 로 iTunes 검색 → 가장 유사한 곡의 previewUrl 반환. 매칭 실패 시
 * null (그 트랙만 YouTube 폴백 유지).
 *
