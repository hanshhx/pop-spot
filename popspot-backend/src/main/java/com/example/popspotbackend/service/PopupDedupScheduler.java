 ...
 *
 * <p>자동수집(04:00·16:00 KST) 뒤 05:00·17:00 에 실행해, 같은 이름의 중복이 지도/검색에 남지 않게 한다. 크롤러 파일을
 * 건드리지 않고 독립 스케줄로 붙였다(수집 시점의 externalId 해시 dedup 은 위치·날짜 표기가 달라지면 놓치는 한계 보완).
 */
@Slf4j
@Component
...
public class PopupDedupScheduler {
    ...
    @Scheduled(cron = "${popspot.dedup.cron:0 0 5,17 * * *}", zone = "Asia/Seoul")
