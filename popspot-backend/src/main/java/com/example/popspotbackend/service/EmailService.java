...
public class EmailService {
    ...
    private String buildHtmlBody(String authCode) {
        return "<div style='font-family: \"Apple SD Gothic Neo\", sans-serif; background-color:"
                + " #f3f4f6; padding: 40px 20px; text-align: center;'><div style='max-width:"
                + " 500px; margin: 0 auto; background-color: #ffffff; border-radius: 16px;"
                + " padding: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); text-align:"
                + " left;'><div style='text-align: center; margin-bottom: 30px;'><h1"
                + " style='color: #4F46E5; font-size: 28px; font-weight: 900; margin: 0;"
                + " letter-spacing: -1px; font-style: italic;'>POP-SPOT<span style='color:"
                + " #000;'>.</span></h1></div><h2 style='color: #111827; font-size: 20px;"
                + " margin-bottom: 10px;'>회원가입 인증번호</h2><p style='color: #6B7280; font-size:"
                + " 14px; line-height: 1.6; margin-bottom: 25px;'>안녕하세요.<br/>POP-SPOT을 이용해 주셔서"
                + " 감사합니다.<br/>아래 인증번호 6자리를 입력하여 본인 인증을 완료해 주세요.</p><div"
                + " style='background-color: #F9FAFB; border: 1px solid #E5E7EB; border-radius:"
                + " 8px; padding: 20px; text-align: center; margin-bottom: 25px;'><span"
                + " style='font-size: 32px; font-weight: 800; color: #4F46E5; letter-spacing:"
                + " 8px;'>"
                + authCode
                + "</span></div><p style='color: #9CA3AF; font-size: 12px; margin-top: 30px;"
                + " border-top: 1px solid #E5E7EB; padding-top: 20px;'>본 메일은 발신 전용입니다.<br/>인증번호는"
                + " 3분간 유효합니다.</p></div><div style='text-align: center; margin-top: 20px;'><p"
                + " style='color: #9CA3AF; font-size: 12px;'>© 2026 POP-SPOT. All rights"
                + " reserved.</p></div></div>";
    }
}
