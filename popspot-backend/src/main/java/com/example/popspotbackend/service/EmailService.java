...
public class EmailService {
    ...
    /** 송신자 주소 — application.properties 의 spring.mail.username 을 그대로 사용 */
    @Value("${spring.mail.username:noreply@popspot.co.kr}")
    private String fromAddress;

    // 인증번호 생성 (6자리) — SecureRandom 으로 예측 불가능
    ...
    public String sendMail(String toEmail) {
        ...
        try {
            ...
            helper.setFrom(fromAddress);  // application.properties 의 spring.mail.username
