 ...
 *
 * <p>이 화면의 목적은 "낯선 곳에서 접속했나" 를 알려 주는 것이지 "어느 집인가" 를 보여 주는 것이
 * 아니다. 온전한 IP 는 감사 로그 원본에 있으므로, 요약까지 평문으로 복제하면 <b>같은 개인정보를
 * 보관하는 자리만 하나 더 늘어난다.</b>
 *
...
class SecurityOverviewMaskTest {
    ...
    /**
     * 점도 콜론도 없는 값은 형태를 모르는 것이다. 그때는 <b>통째로 가린다</b> — 모르는 것을
     * 그대로 내보내는 쪽이 위험하다.
     */
    @Test
