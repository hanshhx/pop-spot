 ...
 * 거짓이 된다.
 *
 * <p>지도는 {@code components/Map/MapCanvas} — MapLibre 로 웹과 같은 타일을 그린다. 예전에는 여기서
 * 핀 좌표를 직접 상자에 투영했는데({@code features/map/project.ts}), 진짜 지도가 그 일을 하므로
 * 그 파일은 지웠다. 손으로 투영하던 코드가 있던 이유는 지도가 없었기 때문이지 필요해서가 아니었다.
 */
  ...
  return (
    <View style={[styles.root, { backgroundColor: t.bg }]}>
      ...
      <MapCanvas
        ...
        onPressPopup={(id) => navigation.navigate('Detail', { id })}
      >
